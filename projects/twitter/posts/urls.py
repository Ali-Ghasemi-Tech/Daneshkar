...
from .views import NewPost , PostDetailsView ,PostEditView , PostDeleteView , like_view ,dislike_view, CommentCreateView , CommentReplyView , DeleteCommentView , search_posts
